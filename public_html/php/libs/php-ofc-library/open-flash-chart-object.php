...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    if( !isset( $open_flash_chart_seqno ) && $use_swfobject)
    {
...
<param name="movie" value="http://www.youtube.com/v/7_6B6vwE83U" /></object> 
*/

/*
<object type="application/x-shockwave-flash" style="width:425px; height:350px;" data="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" 
width="300" height="200" id="ie_chart_1" align="middle">
<param name="movie" value="/open-flash-chart.swf?width=300&amp;height=200&amp;data=http%3A%2F%2Fmotiomera.xord.se%2Fdata%2Fveckograf.php%3Fid%3D2" />
</object>
*/

$out[] = '<object type="application/x-shockwave-flash" style="width:' . $width . 'px; height:' . $height . 'px;" data="'. $base .'open-flash-chart.swf?width='. $width .'&amp;height='. $height . '&amp;data='. $url .'">';
...
/*
    ...
    $out[] = 'style="width:' . $width . 'px;height:' . $height . 'px;" id="ie_'. $obj_id .'" align="middle">';
    $out[] = '<param name="allowScriptAccess" value="sameDomain" />';
    $out[] = '<param name="movie" value="'. $base .'open-flash-chart.swf?width='. $width .'&amp;height='. $height . '&amp;data='. $url .'" />';
