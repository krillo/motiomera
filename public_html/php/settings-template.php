...
$SETTINGS["rapport_mail"] = "per.olsson@aller.se";
...
// Debug
define('DEBUG_OVERRIDE', false); //sätter på debug på sidan
define('DEBUG_MAIL', false); //Sätter på debug via mail
define('DEBUG_SMARTY', false); //Sätter på debug i smarty
define("DEBUG_IM", true); //sätter på debug i IM
define("NO_INTERNET", false);
define("GOOGLEMAPS_OVERRIDE_NO_INTERNET", false);

//Memcache
define('MEMCACHE', false); //Sätter på memcache
...
define('FORETAGSFIL_LOCAL_PATH', "/var/www/krillomera/postpac/order_pdf");
