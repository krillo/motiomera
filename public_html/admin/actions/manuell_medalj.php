...
if(!empty($_GET['year']) && !empty($_GET['weekstart']) && !empty($_GET['weekstop'])){
  ...
  Misc::logMotiomera(date("Y-m-d H:i:s") . " INFO - Manual medalj batch started from Admin, ". $_GET['year']." from week ". $_GET['weekstart']." to week ". $_GET['weekstop'], 'cron_motiomera.log');
