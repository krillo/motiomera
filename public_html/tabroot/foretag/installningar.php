  ...
  <table border="0" cellpadding="0" cellspacing="0" class="motiomera_form_table">
    ...
    <tr>
      ...
      <td>
        ...
        <div id="motiomera_andra_losenord_link">
          <a href="#" onclick="getById('andraLosen').value = '1';
    getById('motiomera_andra_losenord_link').style.display = 'none';
    getById('motiomera_andra_losenord_field').style.display = 'block';
    return false;" title="&Auml;ndra lösenordet till administrationssidan">Ändra lösenord till administrationssidan</a>
        </div>
        <div id="motiomera_andra_losenord_field">
          ...
          <a href="#" onclick="getById('andraLosen').value = '0';
    getById('motiomera_andra_losenord_link').style.display = 'block';
    getById('motiomera_andra_losenord_field').style.display = 'none';
    return false;" title="&Aring;ngra">Ångra</a>
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        ?>
        <a href="#" onclick="motiomera_laddaUppForetagsbild(<?= (isset($_GET["fid"]) ? $_GET["fid"] : "") ?>);
    ...
    <tr>
      ...
      <td>
        ...
        <?php if (isset($ADMIN) && $ADMIN->isTyp(ADMIN) && isset($foretag)) { ?><a href="<?= $urlHandler->getUrl(Foretag, URL_DELETE, $foretag->getId()) ?>" onclick="var q = confirm('Är du säker på att du vill ta bort företaget?');
      return q;" title="Ta bort f&ouml;retaget">Ta bort</a><?php } ?>
      </td>
    </tr>
  </table>
</form>
