...
{*}		
		...
		<tr>
			<td></td>
			<td>
			<input type="checkbox" id="integritetspolicy" value="1" /> Ja, jag godkänner <a href="http://www.integritetspolicy.se/" target="_blank">Allers integritetspolicy</a> och är över 16 år</td>
		</tr>
		<tr class="mmLastRow">
			<td></td>
			<td>
