<div class="mmBlueBoxTop"><h3 class="mmWhite BoxTitle">Framsteg de senaste 7 dagarna</h3></div>
...
<div class="mmBlueBoxTop"><h3 class="mmWhite BoxTitle">Troféer</h3><a href="javascript:;" onclick="mm_rapportera_show_help(11,280,400,'topleft')"><img src="/img/icons/FaqCircleRed.gif" alt="Hjälp" class="mmBlueBoxMiddleFaqCircle" /></a></div>
<div class="mmBlueBoxBg">
