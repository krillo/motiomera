...
{if $sajtDelarObj->medlemHasAccess($medlem,"minSidaGmaps")}
	...
	{if !isset($isProfil)}
	<div id="mmStegGrafikRapporteraSteg" class="GM">
		<a href="#" onclick="motiomera_steg_rapportera(); return false;"><img src="/img/minsida/mmRapporteraSteg_txt.gif" alt="Rapportera Steg" /></a>
	</div>
	<div id="mmStegGrafikValjRutt" class="GM">
		<a href="{$urlHandler->getUrl(Rutt, URL_VIEW, $medlem->getId())}"><img src="/img/minsida/mmValjRutt_txt.gif" alt="Välj en rutt" /></a>
	</div>
	{/if}
...
<div id="mmStegGrafikStartkommunKontainer">
	...
	{if !isset($isProfil)}
	<div id="mmStegGrafikRapporteraSteg">
		<a href="#" onclick="motiomera_steg_rapportera(); return false;"><img src="/img/minsida/mmRapporteraSteg_txt.gif" alt="Rapportera Steg" /></a>
	</div>
	<div id="mmStegGrafikValjRutt">
		<a href="{$urlHandler->getUrl(Rutt, URL_VIEW, $medlem->getId())}"><img src="/img/minsida/mmValjRutt_txt.gif" alt="Välj en rutt" /></a>
	</div>
	{/if}
