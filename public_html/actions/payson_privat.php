...
//everthing looks fine sofar, create the user
    ...
    try {
      ...
      if ($payResponse->getResponseEnvelope()->wasSuccessful()) {  // Payson Step 3: verify that it suceeded
        ...
        throw new UserException("Problem med Payson.se", "Det är något problem med betaltjänsten Payson.com. Prova igen senare.");
      }
    ...
    throw new UserException("Priset stämmer inte", "Priset stämmer inte... försök igen: <a href=\"" . $urlrlHandler->getUrl("Medlem", URL_CREATE) . "\">Bli Medlem</a>");
  }
}
?>